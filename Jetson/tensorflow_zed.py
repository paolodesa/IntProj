...
def main(args):
    global detection_graph, category_index, sess, capture_thread
    ...
    # Shared resources
    global image_np_global, depth_np_global, exit_signal
...
def get_frames():
    global exit_signal, detection_graph, category_index, sess, capture_thread, new_data
    while not exit_signal:
        ...
        if new_data:
            ...
            ret, buffer = cv2.imencode('.jpg', cv2.resize(image_np, (width, height)))
