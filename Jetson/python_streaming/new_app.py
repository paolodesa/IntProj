...
def main(argv):
    ...
    weight_path = "yolov4-tiny-face_mask.weights"
    meta_path = "cfg/face_mask.data"
    svo_path = None
    zed_id = 0

    help_str = 'new_app.py -c <config> -w <weight> -m <meta> -t <threshold> -s <svo_file> -z <zed_id>'
    try:
    ...
    global cam, mat, point_cloud_mat, runtime, bodies, obj_runtime_param
    ...
    while True:
        ...
        if err == sl.ERROR_CODE.SUCCESS:
            ...
            for obj in bodies.object_list:    # bodies.object_list crashes the script (bad_alloc)
                ...
                # Do the detection
                detections = detect(netMain, metaMain, cropped_img, thresh)
                ...
                for detection in detections:
                    ...
                    cv2.putText(image, label,
                                (x1 + (thickness * 4), y1 + (10 + thickness * 4)),
